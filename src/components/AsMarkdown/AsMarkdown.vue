...
const props = withDefaults(defineProps<Props>(), {
  isStreaming: false,
  allowedComponents: () => ['df-bar-chart', 'df-radar-chart'],
  customComponents: () => ({}),
...
.yuan-stream-renderer .df-paragraph {
  margin-bottom: 16px;
  color: var(--yuan-text-primary);
}

.yuan-stream-renderer .df-heading {
  font-weight: 700;
  color: var(--yuan-text-primary);
  margin-top: 24px;
  margin-bottom: 12px;
...
.yuan-stream-renderer .df-h1 { font-size: 1.6rem; border-bottom: 1px solid var(--yuan-border); padding-bottom: 6px; }
.yuan-stream-renderer .df-h2 { font-size: 1.4rem; }
.yuan-stream-renderer .df-h3 { font-size: 1.2rem; }
.yuan-stream-renderer .df-h4, .df-h5, .df-h6 { font-size: 1rem; }

.yuan-stream-renderer .df-strong {
  font-weight: 600;
}

.yuan-stream-renderer .df-inline-code {
...
.yuan-stream-renderer .df-code-block {
  background: #18181c;
...
.yuan-stream-renderer .df-code-block-header {
  background: #111114;
...
.yuan-stream-renderer .df-code-block-lang {
  font-size: 10px;
...
.yuan-stream-renderer .df-code-block-copy {
...
.yuan-stream-renderer .df-code-block-copy:hover {
  background: rgba(255, 255, 255, 0.06);
  color: #ffffff;
  border-color: rgba(255, 255, 255, 0.15);
}

.yuan-stream-renderer .df-code-block-copy.copied {
  color: #10b981;
  background: rgba(16, 185, 129, 0.08);
  border-color: rgba(16, 185, 129, 0.2);
}

.yuan-stream-renderer .df-code-block-pre {
  margin: 0;
  padding: 14px 16px;
  overflow-x: auto;
  font-family: var(--yuan-font-mono), SFMono-Regular, Menlo, Monaco, Consolas, monospace;
...
.yuan-stream-renderer .df-block-enter {
  animation: df-block-enter 0.18s ease-out both;
}
